    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item"><a class="nav-link <?php if ($view === "welcome"): ?>active<?php endif; ?>" href="index.php">Home</a></li>
                <li class="nav-item"><a class="nav-link <?php if ($view === "list"): ?>active<?php endif; ?>" href="index.php?view=list">List</a></li>
